...
export default function SchedulePage() {
  ...
  return (
    <div className="max-w-[1800px] mx-auto p-2 sm:p-4 md:p-6 h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-4 md:gap-6 lg:gap-8 flex-1 overflow-hidden">
        {(isMobileView && activeTab === 'calendar') || !isMobileView ? (
          <div className="bg-white rounded-xl p-4 md:p-6 lg:p-8 shadow-md flex-1 min-w-0 overflow-hidden">
        ...
        {(isMobileView && activeTab === 'notifications') || !isMobileView ? (
          <div className={`bg-white rounded-xl p-4 md:p-6 lg:p-8 shadow-md ${isMobileView ? 'w-full' : 'w-full lg:w-[400px] xl:w-[450px]'} min-w-0 flex flex-col`}>
            <div className="flex items-center justify-between mb-4 md:mb-6">
